    ...
    <div class="d-flex flex-nowrap overflow-auto pb-3 mb-4 scroll-horizontal">
        ...
        <div class="card-body p-4 d-flex flex-column justify-content-between" style="min-height: 200px;">
          ...
          <div class="mt-3">
            <a href="<?= BASE_URL ?>modules/mahasiswa/index.php?q=Teknik Informatika"
              ...
              Daftar Mahasiswa <i class="fi fi-rr-arrow-right ms-1" style="font-size: 0.75rem;"></i>
            </a>
          </div>
        </div>
      </div>
      ...
      <div class="card border-0 shadow-sm rounded-4 me-3"
        ...
        <div class="card-body p-4 d-flex flex-column justify-content-between" style="min-height: 200px;">
          ...
          <div class="mt-3">
            <a href="<?= BASE_URL ?>modules/mahasiswa/index.php?q=Sistem Informasi"
              class="btn btn-sm w-100 rounded-3 text-white"
              style="background-color: var(--prussian-blue); font-size: 0.85rem; font-weight: 600;">
              Daftar Mahasiwa <i class="fi fi-rr-arrow-right ms-1" style="font-size: 0.75rem;"></i>
            </a>
          </div>
        </div>
      </div>
      ...
      <div class="card border-0 shadow-sm rounded-4 me-3"
        ...
        <div class="card-body p-4 d-flex flex-column justify-content-between" style="min-height: 200px;">
          ...
          <div class="mt-3">
            <a href="<?= BASE_URL ?>modules/mahasiswa/index.php?q=Ilmu Komputer"
              class="btn btn-sm w-100 rounded-3 text-white"
              style="background-color: var(--prussian-blue); font-size: 0.85rem; font-weight: 600;">
              Daftar Mahasiwa <i class="fi fi-rr-arrow-right ms-1" style="font-size: 0.75rem;"></i>
            </a>
      ...
      <div class="card border-0 shadow-sm rounded-4 me-3"
        ...
        <div class="card-body p-4 d-flex flex-column justify-content-between" style="min-height: 200px;">
          ...
          <div class="mt-3">
            <a href="<?= BASE_URL ?>modules/mahasiswa/index.php?q=Teknik Elektro"
              class="btn btn-sm w-100 rounded-3 text-white"
              style="background-color: var(--prussian-blue); font-size: 0.85rem; font-weight: 600;">
              Daftar Mahasiwa <i class="fi fi-rr-arrow-right ms-1" style="font-size: 0.75rem;"></i>
            </a>
      ...
      <div class="card border-0 shadow-sm rounded-4 me-3"
        ...
        <div class="card-body p-4 d-flex flex-column justify-content-between" style="min-height: 200px;">
          ...
          <div class="mt-3">
            <a href="<?= BASE_URL ?>modules/mahasiswa/index.php?q=Sains Data"
              class="btn btn-sm w-100 rounded-3 text-white"
              style="background-color: var(--prussian-blue); font-size: 0.85rem; font-weight: 600;">
              Daftar Mahasiwa <i class="fi fi-rr-arrow-right ms-1" style="font-size: 0.75rem;"></i>
            </a>
      ...
      <div class="card border-0 shadow-sm rounded-4 me-3"
        ...
        <div class="card-body p-4 d-flex flex-column justify-content-between" style="min-height: 200px;">
          ...
          <div class="mt-3">
            <a href="<?= BASE_URL ?>modules/mahasiswa/index.php?q=Bisnis Digital"
              class="btn btn-sm w-100 rounded-3 text-white"
              style="background-color: var(--prussian-blue); font-size: 0.85rem; font-weight: 600;">
              Daftar Mahasiwa <i class="fi fi-rr-arrow-right ms-1" style="font-size: 0.75rem;"></i>
            </a>
      ...
      <div class="card border-0 shadow-sm rounded-4 me-3"
        ...
        <div class="card-body p-4 d-flex flex-column justify-content-between" style="min-height: 200px;">
          ...
          <div class="mt-3">
            <a href="<?= BASE_URL ?>modules/mahasiswa/index.php?q=Teknologi Informasi"
              class="btn btn-sm w-100 rounded-3 text-white"
              style="background-color: var(--prussian-blue); font-size: 0.85rem; font-weight: 600;">
              Daftar Mahasiwa <i class="fi fi-rr-arrow-right ms-1" style="font-size: 0.75rem;"></i>
            </a>
